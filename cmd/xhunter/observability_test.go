...
func TestEndToEnd_EventAndResultShareEffectiveConfigAndUsage(t *testing.T) {
	...
	wantPrim := []any{"read", "write", "edit", "find", "glob", "symbol_read", "symbol_edit", "symbol_rename", "check", "checkpoint"}
...
func TestDefaultAssembly_EffectiveConfigPrimitivesMatchToolFace(t *testing.T) {
	...
	want := []string{"read", "write", "edit", "find", "glob", "symbol_read", "symbol_edit", "symbol_rename", "check", "checkpoint"}
